...
function checkInputs(){
    ...
    if(usernameValue === ''){
        //show error
        //add error class
        setErrorFor(username,'Please fill the field');
    }else{
        //add success class
        setSuccessFor(username);
    }
    if(emailValue === ''){
        setErrorFor(email,'Please fill the field');
    ...
    if(passwordValue === ''){
        setErrorFor(password,'Please fill the field');
    }else{
        setSuccessFor(password);
    }
    if(password_checkValue === ''){
        setErrorFor(password_check,'Please fill the field');
